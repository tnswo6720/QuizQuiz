...
const Quiz = () => {
  const initialQuestions = [
    ...
    {
      questionText:
        "다음 주어진 URL 'http://example.com:3000/posts?id=1'에서 각각의 구성요소를 맞춰보세요.",
      answerOptions: [
        ["http", "example.com", "3000", "/posts", "id=1"],
        ["https", "example.com", "3000", "/posts", "id=1"],
        ["http", "example.com", "80", "/posts", "id=1"],
        ["http", "example.com", "3000", "/users", "id=1"],
      ],
      answer: ["http", "example.com", "3000", "/posts", "id=1"],
      explanation:
        "이 URL에서 'http'는 프로토콜, 'example.com'는 호스트, '3000'는 포트, '/posts'는 경로, 'id=1'는 쿼리 파라미터입니다.",
    },
    {
      questionText:
