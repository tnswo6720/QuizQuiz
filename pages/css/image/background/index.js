...
import { Wrapper, Section, Button } from "./style"; // 스타일 컴포넌트 불러오기
...
const Quiz = () => {
  const initialQuestions = [
...

    {
      ...
      answer: "세렌이 소환된 직후 레이저 빔을 쏘면 캐릭터가 움직여지지 않는다",
      explanation:
    ...
    },
    {
      ...
      answer: "세렌의 태양 베기 1,2타를 전부 숙여서 피할 수 없게 되었다.",
      explanation:
    ...
    },
    {
      topic: " 보스 패턴",
      questionText:
        "캐릭터 대가리에 해당 화면이 보일 때 대한 상황 설명과 대처 방법은?",
      image: "/cha.gif",
      answerOptions: [
        "중독에 걸린 상황이다.",
        "피가 계속 깍이고 물약도 안먹어진다",
