...
const Quiz = () => {
  const initialQuestions = [
    ...
    {
      questionText:
        "CSS에서 배경 이미지를 반복하지 않고 한 번만 표시하려고 합니다. 다음 코드에서 빈칸에 들어갈 적절한 속성 값은 무엇일까요?",
      code: `
        .element {
      ...
      answer: "no-repeat",
      explanation:
        "CSS에서 배경 이미지를 반복하지 않고 한 번만 표시하려면 'background-repeat' 속성 값을 'no-repeat'으로 설정합니다.",
      explanationCode: "",
    },
    {
      questionText:
        "CSS에서 키 프레임 애니메이션을 만들려고 합니다. 다음 코드에서 빈칸에 들어갈 적절한 코드는 무엇일까요?",
      code: `
        ______ fadeIn {
          0% { opacity: 0; }
          100% { opacity: 1; }
      ...
      `,
      answerOptions: ["@keyframes", "@frames", "@keyframe", "@frame"],
      answer: "@keyframes",
      explanation:
        "CSS에서 키프레임 애니메이션을 만들 때는 '@keyframes'를 사용합니다. 이후 괄호 안에 각 키프레임에서 적용할 스타일을 지정해주면 됩니다.",
      explanationCode: "",
    },
  ];
