...
const Quiz = () => {
  const initialQuestions = [
    ...
    {
      questionText:
        "NestJS에서 TypeORM 레퍼지토리를 주입하기 위해 사용하는 데코레이터는 무엇인가요?",
      code: `
        @Injectable()
      ...
      answer: "InjectRepository",
      explanation:
        "NestJS에서 TypeORM 레퍼지토리를 주입할 때는 '@InjectRepository()' 데코레이터를 사용합니다. 이를 통해 해당 모델에 대한 레퍼지토리를 주입받을 수 있습니다.",
    },
    {
      questionText: "NestJS에서 특정 모듈을 현재 모듈에 등록하려면 어떤 구문을 사용해야 하나요?",
      code: `
        @Module({
          imports: [______([PostsModule])],
          controllers: [PostsController],
          providers: [PostsService],
        })
        export class AppModule {}
      `,
      answerOptions: ["TypeOrmModule.forFeature", "TypeOrmModule.forRoot", "TypeOrmModule.register", "TypeOrmModule.load"],
      answer: "TypeOrmModule.forFeature",
      explanation: "NestJS에서 특정 모듈을 현재 모듈에 등록하려면 'TypeOrmModule.forFeature()'를 사용합니다. 이 함수는 특정 모듈의 레퍼지토리를 현재 모듈로 가져옵니다.",
      },
  ];
